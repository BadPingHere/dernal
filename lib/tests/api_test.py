...
timeframes = ["Last 7 Days", "All Time"] # erm... UPDATE THIS TODO!!!!!!!!!!!!!!!!
...
def testLeaderboard(uuid, timeframe, leaderboardType):
    ...
    if timeframe != "All Time":
        ...
        params.update(start=(end - timedelta(hours=168)).isoformat(), end=end.isoformat())
    response = client.get(f"/api/leaderboard/{leaderboardType}", params=params)
