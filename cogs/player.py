...
class Player(commands.GroupCog, name="player"):
    ...
    async def guild_history(self, interaction: discord.Interaction, name: str):
        ...
        embed = await asyncio.to_thread(playerGuildHistory, playerUUID, name)
        if embed:
    ...
    leaderboardRaids.autocomplete("timeframe")(autocompletLeaderboardTimeframe)
    leaderboardGRaids.autocomplete("timeframe")(autocompletLeaderboardTimeframe)
    leaderboardDungeons.autocomplete("timeframe")(autocompletLeaderboardTimeframe)
    leaderboardPlaytime.autocomplete("timeframe")(autocompletLeaderboardTimeframe)
